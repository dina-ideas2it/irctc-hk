(function() {
  ...
  function PaymentInfoController($scope, $filter, $mdSidenav, $mdDialog, DataService) {
    ...
    var banksForInternet = [{'value':'-1','label':'Select Bank'},{'value':'1','label':'State Bank of India'},{'value':'10','label':'State Bank of India and Associates'},{'value':'22','label':'Federal Bank'},{'value':'29','label':'Indian Bank'},{'value':'28','label':'Union Bank of India'},{'value':'31','label':'Andhra Bank'},{'value':'34','label':'Punjab National Bank '},{'value':'35','label':'Allahabad Bank'},{'value':'38','label':'Vijaya Bank'},{'value':'39','label':'AXIS Bank'},{'value':'36','label':'HDFC Bank'},{'value':'37','label':'Bank of Baroda'},{'value':'42','label':'Karnataka Bank'},{'value':'40','label':'Karur Vysya Bank'},{'value':'46','label':'Kotak Mahindra Bank'},{'value':'47','label':'INGVysya Bank'},{'value':'44','label':'ICICI Bank '},{'value':'45','label':'IndusInd Bank'},{'value':'51','label':'IMPS'},{'value':'50','label':'Central Bank of India'},{'value':'48','label':'Bank of India'},{'value':'54','label':'Syndicate Bank'},{'value':'53','label':'Bank of Maharashatra'},{'value':'52','label':'IDBI Bank'},{'value':'56','label':'Corporation Bank'}];
    var bankForDebitCards = [{'value':'-1','label':'Select Bank'},{'value':'3','label':'State Bank of India'},{'value':'9','label':'Punjab National Bank'},{'value':'15','label':'Indian Bank'},{'value':'16','label':'Union Bank of India '},{'value':'19','label':'Bank of India'},{'value':'25','label':'Andhra Bank'},{'value':'26','label':'Canara Bank'},{'value':'32','label':'CITI Bank'},{'value':'41','label':'ICICI Bank'},{'value':'57','label':'HDFC Bank'},{'value':'66','label':'AXIS Bank'}];
    var paymentGateways = [{'value':'-1','label':'Select Bank'},{'value':'4','label':'Visa/Master Card(Powered By ICICI BANK)'},{'value':'17','label':'Visa/Master Card(Powered By CITI BANK)'},{'value':'21','label':'Visa/Master Card(Powered By HDFC BANK)'},{'value':'27','label':'American Express'},{'value':'30','label':'Visa/Master Card(Powered By AXIS BANK)'},{'value':'58','label':'RuPay Card (Powered by Kotak Bank)'}];



    vm.banks = [];

    vm.changeBankList = function(paymentType){
        if(paymentType == 'NETBANKING'){
            vm.banks = banksForInternet;
        } else if(paymentType == 'CREDIT_CARD'){
            vm.banks = paymentGateways;
        } else if(paymentType == 'DEBIT_CARD'){
            vm.banks = bankForDebitCards;
        }
    }

    vm.savePayment = function(){
        console.log(vm.payment);
        DataService.savePayment(vm.payment);
    }

    var init = function(){
        vm.payment.paymentType = 'NETBANKING';
        vm.changeBankList(vm.payment.paymentType);
    }
    init();
